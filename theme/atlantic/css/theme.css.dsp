...
.adwindow-left-navbtn-sel {
	//border-left: none;
	//border-right: none;
    border-top: 2px solid #3f8dcd;
    border-bottom: 2px solid #3f8dcd;
    border-left: 2px solid #3f8dcd;
    border-right: 2px solid #3f8dcd;
	text-align: right;
...
.adtab-tabpanels {
    ...
    border-top: 2px solid #25a8f4;
    border-bottom: 2px solid #25a8f4;
    border-left: 2px solid #25a8f4;
    border-right: 2px solid #25a8f4;
